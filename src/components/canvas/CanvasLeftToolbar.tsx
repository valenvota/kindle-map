...
const TOOLS: ToolItem[] = [
  ...
  { kind: 'tool', tool: 'text',      icon: <Type className="h-4 w-4" />,           label: 'Text' },
  { kind: 'tool', tool: 'room',      icon: <DoorOpen className="h-4 w-4" />,       label: 'Room' },
  { kind: 'separator' },
  ...
  { kind: 'tool', tool: 'region',    icon: <Group className="h-4 w-4" />,          label: 'Region' },
  { kind: 'tool', tool: 'image',     icon: <ImagePlus className="h-4 w-4" />,      label: 'Image' },
  { kind: 'separator' },
